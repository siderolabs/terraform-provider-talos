...
func TestAccTalosMachineSecretsResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccTalosMachineSecretsResourceConfig("", "talos"),
			...
			{
				Config: testAccTalosMachineSecretsResourceConfig(semver.MajorMinor(gendata.VersionTag), "talos"),
			...
			{
				Config: testAccTalosMachineSecretsResourceConfig("v1.2.0", "talos"),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
			...
			{
				Config: testAccTalosMachineSecretsResourceConfig("v1.4", "talos"),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectNonEmptyPlan(),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("talos_machine_secrets.this", "machine_secrets.certs.os.key", "LS0tLS1CRUdJTiBFRDI1NTE5IFBSSVZBVEUgS0VZLS0tLS0KTUM0Q0FRQXdCUVlESzJWd0JDSUVJSlVlQmxic3hhMW0vR1B0NTZCeVIvZ1Z3YWRzVmdkc3pXZEh4MWZiZ0c4VwotLS0tLUVORCBFRDI1NTE5IFBSSVZBVEUgS0VZLS0tLS0K"),
					resource.TestCheckNoResourceAttr("talos_machine_secrets.this", "machine_secrets.secrets.aescbc_encryption_secret"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("talos_machine_secrets.this", "machine_secrets.secrets.secretbox_encryption_secret"),
					...
					resource.TestCheckResourceAttr("talos_machine_secrets.this", "machine_secrets.certs.os.key", "LS0tLS1CRUdJTiBFRDI1NTE5IFBSSVZBVEUgS0VZLS0tLS0KTUM0Q0FRQXdCUVlESzJWd0JDSUVJRjdtNmJKWHNOd3F4ejFMaXRnVlFJSEx5WDJab1hadW85UTNEZjRGSThWaAotLS0tLUVORCBFRDI1NTE5IFBSSVZBVEUgS0VZLS0tLS0K"),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// create talos_machine_secrets resource with talos version 0.1.2
			{
				...
				Config: testAccTalosMachineSecretsResourceConfig("", "talosv1"),
				Check: resource.ComposeTestCheckFunc(
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// create talos_machine_secrets resource with talos version 0.1.2
			{
				...
				Config: testAccTalosMachineSecretsResourceConfig("v1.2", "talosv1"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("talos_machine_secrets.this", "id"),
					resource.TestCheckResourceAttr("talos_machine_secrets.this", "talos_version", "v1.2"),
					resource.TestCheckResourceAttrSet("talos_machine_secrets.this", "machine_secrets"),
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// create talos_machine_secrets resource with talos version 0.1.2
			{
				...
				Config: testAccTalosMachineSecretsResourceConfig("v1.1", "talosv1"),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("talos_machine_secrets.this", "id"),
...
func testAccTalosMachineSecretsResourceConfig(talosConfigVersion string, providerName string) string {
...
`, providerName, talosConfigVersion)
	}
