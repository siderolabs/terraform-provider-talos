					...
					resource.TestCheckResourceAttrWith("data.talos_machine_configuration.this", "machine_configuration", func(value string) error {
						return validateGeneratedTalosMachineConfig(
							...
							func(t *testing.T, config v1alpha1.Config) error {
								...
								// secretboxEncryptionSecret deprecated in Talos v1.14; no longer generated by default.
					...
					resource.TestCheckResourceAttrWith("data.talos_machine_configuration.this", "machine_configuration", func(value string) error {
						return validateGeneratedTalosMachineConfig(
							...
							func(t *testing.T, config v1alpha1.Config) error {
								...
								assert.Equal(t, map[string][]string{"foo": {"bar"}}, config.ClusterConfig.APIServer().ExtraArgs())
...
func validateGeneratedTalosMachineConfig(
	...
	assert.True(t,
		strings.Contains(mc, "DiscoveryServiceConfig") || machineConfig.Cluster().Discovery().Enabled(),
		"discovery should be enabled (inline for <1.14, multidoc for 1.14+)")
